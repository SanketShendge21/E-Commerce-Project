			...
			<div id="carouselExampleIndicators" className="relative" data-te-carousel-init data-te-ride="carousel">
				...
				<div className="relative w-full h-[60vh] overflow-hidden after:clear-both after:block after:content-['']">
					<div
						...
						data-te-carousel-active
					>
						<img src="/tshirts.jpg" className="block w-full h-full object-cover" alt="Tshirts" />
					</div>
					<div
						className="relative float-left -mr-[100%] hidden w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
						data-te-carousel-item
					>
						<img src="/store.jpg" className="block w-full h-full object-cover" alt="Store" />
					</div>
					<div
						className="relative float-left -mr-[100%] hidden w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
						data-te-carousel-item
					>
						<img src="/store1.jpg" className="block w-full h-full object-cover" alt="Store 1" />
					</div>
				</div>
