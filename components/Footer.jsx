...
const Footer = () => {
  return (
    <div>
        <footer className="text-gray-600 body-font" style={{background:'whitesmoke'}}>
        ...
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <Link className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900" href={"/"}>
                <Image src="/logo.png" alt="Error" width={250} height={100} />  
            </Link>
            <p className="mt-2 text-sm text-gray-500">Wear authentic clothes</p>
        </div>
        ...
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 Threads Unveiled —
            <a href="https://twitter.com/SanketShendge21" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@SanketShendge21</a>
            </p>
