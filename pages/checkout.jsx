  ...
  return (
    <div className='container px-8 sm:m-auto'>
      ...
      <div className="mb-4">
        ...
        <textarea id="address" name="address" className="w-full bg-white rounded border border-gray-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" cols="30" rows="2"></textarea>
      </div>
      </div>
      ...
      <div className='px-2 w-1/2'>
        ...
        <div className="mb-4">
          ...
          <input type="text" id="pincode" name="pincode" className="w-full bg-white rounded border border-gray-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
        </div>
        </div>
      </div>
      ...
      <div className="sideCart bg-slate-50 p-6 m-2 shadow-md">
            ...
            return <li key={k}>
						<div className="item flex my-3">
							<div className="flex font-semibold">{cart[k].name} ({cart[k].variant}/{cart[k].size})</div>
